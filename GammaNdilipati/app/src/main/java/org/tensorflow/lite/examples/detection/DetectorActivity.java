...
import org.tensorflow.lite.examples.detection.tracking.CameraActivity;
      ...
      mTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener(){
          ...
          public void onInit(int status){
              if (status == TextToSpeech.SUCCESS){
                  int resultT = mTTS.setLanguage(Locale.ENGLISH);
                  if (resultT== TextToSpeech.LANG_MISSING_DATA || resultT == TextToSpeech.LANG_NOT_SUPPORTED){
                      Log.e("TSS","Langage not supported");
                  }
                  else{
                      Log.e("TSS","Initilisation failed");
                  }
              }
          }
      });
          ...
          public void run() {
            ...
            for (final Classifier.Recognition result : results) {
              ...
              if (location != null && result.getConfidence() >= minimumConfidence) {
                ...
                if (mappedRecognitions.contains(result)==false){
